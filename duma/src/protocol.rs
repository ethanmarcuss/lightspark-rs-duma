...
/// LnurlpRequest is the first request in the DUMA protocol.
...
impl LnurlpRequest {
    pub fn encode_to_url(&self) -> Result<url::Url, Error> {
        ...
        lnurlp_url
            ...
            .append_pair("dumaVersion", &self.duma_version);
...
pub struct LnurlpResponse {
    ...
    /// DumaVersion is the version of the UMA protocol that VASP2 has chosen for this transaction
